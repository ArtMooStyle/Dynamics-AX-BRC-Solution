<%@ Page Language="C#" MasterPageFile="~/App.master" AutoEventWireup="true" CodeFile="PalletMove.aspx.cs" Inherits="_PalletMove" validateRequest="false" %>
 ...
 <asp:Panel ID="panMain" runat="server" Width="100%">
     <table>
         <tr class="header">
             ...
             <td><asp:Label ID="lHeader" CssClass="headerLabel" runat="server" Text="Pallet move" meta:resourcekey="res_lHeader" /></td>
             </tr>
         <tr>
             <td colspan="2" style="background-color: #ffff80;">
                 <asp:Label ID="lInfo" CssClass="info" runat="server" meta:resourcekey="res_lInfo" Text="Scan Pallet ID to obtain info..."/>
                 </td>
             </tr>
         </table>
