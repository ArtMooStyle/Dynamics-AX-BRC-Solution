<%@ Page Language="C#" MasterPageFile="~/App.master" AutoEventWireup="true" CodeFile="PalletBlock.aspx.cs" Inherits="_PalletBlock" validateRequest="false" %>
 ...
 <asp:Panel ID="panMain" runat="server" Width="100%">
     <table>
         <tr class="header">
             ...
             <td><asp:Label ID="lHeader" CssClass="headerLabel" runat="server" Text="Block pallet" meta:resourcekey="res_lHeader" /></td>
             </tr>
         <tr>
